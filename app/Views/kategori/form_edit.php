...
<head>
    <title>FORM EDIT KATEGORI PERPUSTAKAAN AMIKOM</title>
    <meta charset="UTF-8">
...
<body class="bg-slate-800 min-h-screen ">
    <div class="bg-primary py-3 flex justify-center">
        ...
        <div class="mx-auto">
            <h1 class="text-xl text-white font-bold text-center ">Form Edit Pengisian Kategori Buku Perpustakaan</h1>
    ...
    <!-- Dashboard RPS -->
    <form action="<?= base_url('proses_edit_kategori') ?>" method="POST" class="flex justify-center items-center ">
        <div class="card w-96 shadow-xl bg-slate-700 ">
            <div class="w-96 p-6 ">
                ...
                <div class="form-control w-full ">
                    <label class="label">
                        <span class="label-text text-l text-white">kategori</span>
                    </label>
                    <select name="kategori" class="select select-warning w-full max-w-xs">
                        <option disabled>--Pilih kategori--</option>
                        <option value="Fiksi" <?= ($xp['kategori'] == 'Fiksi') ? 'selected' : '' ?>>Fiksi</option>
                        <option value="Sains" <?= ($xp['kategori'] == 'Sains') ? 'selected' : '' ?>>Sains</option>
                    </select>

                    <!-- <input id="kategori" name="kategori" type="text" placeholder="Type here" class="input input-bordered w-full shadow-l focus:ring-2 focus:ring-yellow-400" /> -->
                </div>
                <div class="form-control w-full ">
                    <label class="label">
                ...
                <div class="form-control w-full ">
                    <label class="label">
                        <span class="label-text text-l text-white">nomor Rak</span>
                    </label>
                    <input id="nomor_rak" name="nomor_rak" value="<?= $xp['nomor_rak'] ?>" type="text" placeholder="Type here" class="input input-bordered w-full shadow-2xl focus:ring-2 focus:ring-yellow-400" />
                </div>
