...
<head>
    <title>FORM EDIT PENGEMBALIAN PERPUSTAKAAN AMIKOM</title>
    <meta charset="UTF-8">
...
<body class="bg-slate-800 min-h-screen ">
    <div class="bg-primary py-3 flex justify-center">
        ...
        <div class="mx-auto">
            <h1 class="text-xl text-white font-bold text-center ">Form Edit Pengembalian Buku Perpustakaan</h1>
    ...
    <form action="<?= base_url('proses_edit_pengembalian') ?>" method="POST" class="flex justify-center items-center ">
        <div class="card w-96 shadow-xl bg-slate-700 ">
            <div class="w-96 p-6 ">
                ...
                <div class="form-control w-full ">
                    ...
                    <input id="tanggal_pengembalian" value="<?= $xp['tanggal_pengembalian']?>" name="tanggal_pengembalian" type="date" class="input input-bordered w-full shadow-2xl focus:ring-2 focus:ring-yellow-400" required />
                </div>
