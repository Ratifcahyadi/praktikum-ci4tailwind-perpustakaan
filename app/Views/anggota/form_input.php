...
<head>
    <title>FORM INPUT ANGGOTA AMIKOM</title>
    <meta charset="UTF-8">
...
<body class="bg-slate-800 min-h-screen ">
    ...
    <!-- Dashboard RPS -->
    <form action="<?= base_url('proses_add_anggota') ?>" method="POST" class="flex justify-center items-center ">
        ...
        <div class="card w-96 shadow-xl bg-slate-700 ">
            <div class="w-96 p-6 ">
                ...
                <div class="form-control w-full ">
                    ...
                    <input id="nama" name="nama" type="text" placeholder="Type here" class="input input-bordered w-full shadow-l focus:ring-2 focus:ring-yellow-400" />
                </div>
                <div class="form-control w-full ">
                    <label class="label">
                ...
                <div class="form-control w-full ">
                    ...
                    <input id="prodi" name="prodi" type="text" placeholder="Type here" class="input input-bordered w-full shadow-2xl focus:ring-2 focus:ring-yellow-400" />
                </div>
