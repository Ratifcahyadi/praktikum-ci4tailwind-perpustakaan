...
<head>
    <title>FORM INPUT DATA BUKU AMIKOM</title>
    <meta charset="UTF-8">
...
<body class="bg-slate-800 min-h-screen ">
    <div class="bg-primary py-3 flex justify-center">
        ...
        <div class="mx-auto">
            <h1 class="text-xl text-white font-bold text-center ">Form Pengisian Daftar Buku Perpustakaan</h1>
    ...
    <!-- Dashboard RPS -->
    <form action="<?= base_url('proses_add_buku') ?>" method="POST" class="flex justify-center items-center ">
        ...
        <div class="card w-96 shadow-xl bg-slate-700 ">
            <div class="w-96 p-6 ">
                ...
                <div class="form-control w-full ">
                    ...
                    <input id="kode_buku" name="kode_buku" type="text" placeholder="Type here" class="input input-bordered w-full shadow-l focus:ring-2 focus:ring-yellow-400" />
                </div>
                <div class="form-control w-full ">
                    <label class="label">
                        <span class="label-text text-l text-white">Judul Buku</span>
                    </label>
                    <input id="judul_buku" name="judul_buku" type="text" placeholder="Type here" class="input input-bordered w-full shadow-l focus:ring-2 focus:ring-yellow-400" />
                </div>
